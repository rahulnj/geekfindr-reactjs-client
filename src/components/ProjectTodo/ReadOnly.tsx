    ...
    return (
        <div className="projecttodo_wrapper">
            <div className="projecttodo_wrapper_nostatus">
                ...
                <hr />
                {projectDetails?.project?.todo[0]?.tasks?.map((todo: Todo, index: string) => (
            ...
            <div className="projecttodo_wrapper_nextup">
                ...
                <hr />
                {projectDetails?.project?.todo[1]?.tasks?.map((todo: Todo, index: string) => (
                    <div key={index} className='projecttodo_singletodo'>
                        {todo}
                    </div>
                ))}
            ...
            <div className="projecttodo_wrapper_inprogress">
                ...
                <hr />
                {projectDetails?.project?.todo[2]?.tasks?.map((todo: Todo, index: string) => (
                    <div key={index} className='projecttodo_singletodo'>
                        {todo}
                    </div>
                ))}
            ...
            <div className="projecttodo_wrapper_completed">
                ...
                <hr />
                {projectDetails?.project?.todo[3]?.tasks?.map((todo: Todo, index: string) => (
                    <div key={index} className='projecttodo_singletodo'>
                        {todo}
                    </div>
                ))}
